...
//	GLUquadricObj *obj = gluNewQuadric();
	...
	glVertex3f(70.0,25,-25);
	glVertex3f(70.0,25,-45);
	glEnd();
	...
	glBegin(GL_QUADS);
	glColor3ub(255, 196, 140);
	glVertex3f(80.0,13,-55);
	glVertex3f(80.0,13,-45);
	glVertex3f(80.0,35,-45);
	glVertex3f(80.0,35,-55);
	glEnd();

	//GEDUNG KANAN BELAKANG batang kiri
	glBegin(GL_QUADS);
	glColor3ub(255, 196, 140);
	glVertex3f(70.0,13,-55);
	glVertex3f(70.0,13,-45);
	glVertex3f(70.0,35,-45);
	glVertex3f(70.0,35,-55);
	glEnd();
	...
	glBegin(GL_QUADS);
	glColor3ub(255, 196, 140);
	glVertex3f(80.0,13,-15);
	glVertex3f(80.0,13,-25);
	glVertex3f(80.0,35,-25);
	glVertex3f(80.0,35,-15);
	glEnd();
	...
	glColor3ub(255, 196, 140);
	glVertex3f(70.0,13,-25);
	glVertex3f(70.0,13,-15);
	glVertex3f(70.0,35,-15);

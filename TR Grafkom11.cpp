...
//	GLUquadricObj *obj = gluNewQuadric();
    ...
    //pohon induk
	glPushMatrix();
	glTranslatef(-58,20,10);
	glColor3ub(173 ,255 ,47	);
	glRotatef(90,90,0,0);
	//glScalef(1.0,1.0,0.0);
	glutSolidSphere(9,14,16);
	glPopMatrix();

    //pohon anak 1
	glPushMatrix();
	glTranslatef(-59,20,17);
	glColor3ub(173 ,255 ,47	);
	glRotatef(90,90,0,0);
	//glScalef(1.0,1.0,0.0);
	glutSolidSphere(4,9,11);
	glPopMatrix();

	//pohon anak 2
	glPushMatrix();
	glTranslatef(-58,15,5);
	glColor3ub(173 ,255 ,47	);
	glRotatef(90,90,0,0);
	//glScalef(1.0,1.0,0.0);
	glutSolidSphere(4,9,11);

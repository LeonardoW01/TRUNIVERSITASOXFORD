...
//	GLUquadricObj *obj = gluNewQuadric();
	...
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(19.9,0,-27);
	glVertex3f(19.5,0,-43);
	glVertex3f(19.5,-13,-43);
	glVertex3f(19.5,-13,-27);
	glEnd();

	//PINTU GEDUNG TEMBOK KANAN BELAKANG
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(30.1,0,-27);
	glVertex3f(30.1,0,-43);
	glVertex3f(30.1,-13,-43);
	glVertex3f(30.1,-13,-27);
	glEnd();
	...
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(19.9,-6,21);
	glVertex3f(19.9,-6,26);
	glVertex3f(19.9,8,26);
	glVertex3f(19.9,8,21);
	glEnd();

	//JENDELA BESAR TENGAH
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(19.9,-10,10);
	glVertex3f(19.9,-10,20);
	glVertex3f(19.9,10,20);
	glVertex3f(19.9,10,10);
	glEnd();
	...
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(19.9,-6,-91);
	glVertex3f(19.9,-6,-96);
	glVertex3f(19.9,8,-96);
	glVertex3f(19.9,8,-91);
	glEnd();

	//JENDELA BESAR KANAN
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(19.9,-6,-74);
	glVertex3f(19.9,-6,-79);
	glVertex3f(19.9,8,-79);
	glVertex3f(19.9,8,-74);
	glEnd();

	//JENDELA BESAR TENGAH
	glBegin(GL_QUADS);
	glColor3ub(18, 18, 18);
	glVertex3f(19.9,-10,-80);
	glVertex3f(19.9,-10,-90);
	glVertex3f(19.9,10,-90);
	glVertex3f(19.9,10,-80);
